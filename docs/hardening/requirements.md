...
| 40 | Review Autosave Semantics | Partial | Serialized autosaves/draft preservation/history and hydration races covered. Per-note split-pane save/conflict status and recovery are verified in Electron; broader stale-response/metadata reconciliation review remains. |
