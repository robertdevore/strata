...
| 4 | Harden Electron Navigation | Partial | security/navigation.ts and real Electron checks deny file navigation/popups; production HTML CSP blocks inline execution. Explicit permission validation remains outstanding. |
