> Historical design, preserved 2026-09-08. The shell bridge described below has been removed. Do not implement or invoke these examples as current capabilities. See [current publishing behavior](../publish-providers.md).
