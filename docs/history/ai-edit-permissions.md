> Historical pre-hardening design. This document does not describe current permissions, history, authentication, or revert behavior. See [current AI edit permissions](../ai-edit-permissions.md).
