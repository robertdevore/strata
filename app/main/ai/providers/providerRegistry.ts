...
export const PROVIDER_PRESETS: AiProviderPreset[] = [
  {
    ...
    defaultModel: 'gpt-4o',
    knownModels: ['gpt-5.3-codex', 'gpt-4o', 'gpt-4o-mini', 'o4-mini'],
  ...
  },
  {
    ...
    knownModels: ['deepseek-v4-flash', 'deepseek-chat'],
  ...
  },
  {
    ...
    knownModels: ['deepseek-v4-pro', 'deepseek-reasoner'],
    apiKeySetting: 'aiDeepseekApiKey',
    enabled: true,
    role: 'premium',
  },
  {
    ...
    knownModels: ['kimi-k2.6', 'moonshot-v1-8k'],
  ...
  },
  {
    ...
    knownModels: ['openai/gpt-4o', 'anthropic/claude-sonnet-4', 'google/gemini-2.5-pro'],
