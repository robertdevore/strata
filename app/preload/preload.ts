...
const api: StrataApi = {
	notes: {
		...
		restore: (id, expectedRevision) => ipcRenderer.invoke(IPC_CHANNELS.notesRestore, { id, expectedRevision }),
		archive: (id, archived, expectedRevision) => ipcRenderer.invoke(IPC_CHANNELS.notesArchive, { id, archived, expectedRevision }),
		star: (id, starred, expectedRevision) => ipcRenderer.invoke(IPC_CHANNELS.notesStar, { id, starred, expectedRevision }),
	},
	tags: {
