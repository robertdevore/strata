...
export const HOME_TILE_OPTIONS: HomeTileOption[] = [
  ...
  { action: 'quick_open', label: 'Quick Open', description: 'Jump to an existing note with a fast search.' },
  {
    action: 'focus_search',
    label: 'Search',
    description: 'Jump to the sidebar search field and find notes fast.',
  },
  {
    action: 'open_tags',
    label: 'Browse Tags',
    description: 'Open the tag browser to organize and revisit topics.',
  },
  {
    action: 'open_projects',
    label: 'Browse Projects',
    description: 'See every project in a grid with counts and recent activity.',
  },
  {
    action: 'open_settings',
    label: 'Settings',
    description: 'Customize Strata and tune it to your workflow.',
  },
  {
    action: 'toggle_filters',
    label: 'Toggle Filters',
    description: 'Show or hide the filters panel without leaving the editor.',
  },
  {
    action: 'toggle_sidebar',
    label: 'Toggle Sidebar',
    description: 'Clear the workspace or bring the note list back.',
  },
  {
    action: 'new_project',
    label: 'New Project',
    description: 'Create a project bucket before importing related notes.',
  },
]
