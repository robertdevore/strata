  ...
  return createPortal(
    ...
    >
      <div className="modal-card related-notes-modal" onClick={(event) => event.stopPropagation()}>
        ...
        <button className="icon-button modal-close-button" onClick={onClose} aria-label="Close">
          <CloseIcon />
        </button>
          ...
          <>
            <div className="publish-format-row">
              {(
                ...
                <label
                  key={fmt}
                  className={`publish-format-option ${format === fmt ? 'publish-format-active' : ''}`}
                >
                  <input
                    type="radio"
                    name="format"
        ...
        {'publishing' === status && <div className="publish-status">{message}</div>}
        ...
        {'error' === status && (
          <div className="publish-result publish-result-error">
            ...
            <button className="ghost-button" onClick={() => setStatus('idle')}>
              Try Again
            </button>
          </div>
        )}
